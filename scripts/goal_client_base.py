...
resp = client(0) # Calls for service goal_generator giving 0 as bool request, the server will respond
		 # giving x=0, y=0 as coordinates to be reached, this client infact is supposed to be
		 # called when you want the robot to come back to the origin of the axis
